...
\item Integrated structural analysis (segmentation, registration to T1 images, cortical thickness measurement, etc.) to enable relation of ASL measurements to anatomical space 
