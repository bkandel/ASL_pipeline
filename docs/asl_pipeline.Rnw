...
antsApplyTransforms( list( d=3, i=t1.brainx$bmask,n="NearestNeighbor",
...
aal2t1<-antsApplyTransforms( fixed=t1,moving=aal,n="NearestNeighbor",t=t1.brainx$fwdtransforms )
...
qcvaluesw<-getROIValues( cbf.warped2t1, aal2t1, tmask)
@
